...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[radial-gradient(ellipse_at_50%_0%,_rgba(99,102,241,0.12)_0%,_transparent_60%),_var(--color-base)]">
      <div className="w-full max-w-[400px]">
        ...
        <p className="text-center mt-5 text-sm text-[#5a5a72]">
          ...
          <Link to="/register" className="text-indigo-500 no-underline font-medium hover:underline">
            Create one
          </Link>
        </p>
      </div>
